function TemplateCase(data) {
    function setupAndAddModules() {
        ...
        for (var modules = ContentManager.getChildByAttr(data.getXML(), "name", "modules").children,
             l = modules.length, 
             moduleTextArr = [], i = 0;
             l > i; i++) {
        ...
        _instance.addModule(new ReturnModule(90)), BrowserDetect.DESKTOP && _instance.addModule(new CaseOverviewModule)
    }
