function CaseHomeModule(data, infoData, onArrowClick) {
    ...
    function addArrow() {
        _arrow = new RetinaImage("assets/images/logo/arrow-left.png", Assets.RETINA_HANDLE, onArrowLoaded), _arrow.init(), _arrow.style.cursor = "pointer", null != onArrowClick && (Touchable.apply(_arrow), _arrow.onClick(onArrowClick))
    }
