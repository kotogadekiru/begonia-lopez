...
AnimationUtils.DEG_2_RAD = Math.PI / 180, AnimationUtils.getRotationXMatrix = function (rotateX) {
    ...
    target.style.transform = cssTransformMatrix, target.style.msTransform = cssTransformMatrix, target.style.webkitTransform = cssTransformMatrix, target.style.mozTransform = cssTransformMatrix, target.style.oTransform = cssTransformMatrix
    ...
    var trans = AnimationUtils.getTransformationMatrix(translationX, translationY, translationZ),
        result = AnimationUtils.getResultMatrix([trans]),
        cssTransform = AnimationUtils.getStringTransform3d(result);
    ...
    instance.aniSetX = function (value) {
        ...
        if (_renderable !== !1) {
            ...
            instance.style.transform = cssTransformMatrix, instance.style.msTransform = cssTransformMatrix, instance.style.webkitTransform = cssTransformMatrix, instance.style.mozTransform = cssTransformMatrix, instance.style.oTransform = cssTransformMatrix
        }
    }
};