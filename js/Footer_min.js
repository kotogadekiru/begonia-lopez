function Footer(guides) {
    ...
    return _instance.init = function () {
        ...
        _mail = Text.getNewReg(13), _mail.innerHTML = ContentManager.getChildByAttr(data, "name", "email").innerHTML,
        _mail.style.whiteSpace = "nowrap", 
        _phone = Text.getNewReg(13), 
        _phone.innerHTML = ContentManager.getChildByAttr(data, "name", "phone").innerHTML, _phone.style.whiteSpace = "nowrap", 
        _instance.appendChild(_mail), _instance.appendChild(_phone), 
    ...
    _instance.updateLayout = function () {
        ...
        TweenMax.set(_mail, {
            ...
            y: Assets.RESIZE_MANAGER.getScreenHeight() - SiteGuides.OFFSET_BOTOM + textOffset,
            x: guides.getGuide("start") + OFFSET_PHONE
        })
    }, _instance//devuelve instance el div creado a partir del div con data-name = pagefooter
}